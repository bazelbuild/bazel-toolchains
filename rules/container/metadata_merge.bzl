...
rule & packages_metadata merges their contents into a single YAML file.
The tags are added in order & de-duplicated. The de-duplication removes later
occurences of the same tag. The packages are merged in order including any
duplicates.
